...
namespace DriveMgr.SQLServerDAL
{
    ...
    /// 权限（SQL Server数据库实现）
    /// </summary>
    public class Authority : DriveMgr.IDAL.IAuthority
    {
        /// <summary>
        /// 判断当前用户是否有权限
        /// </summary>
        ...
        public bool IfAuthority(string menuCode, string buttonCode, int userId)
        {
            ...
            object result = DriveMgr.Common.SqlHelper.ExecuteScalar(DriveMgr.Common.SqlHelper.connStr, CommandType.Text, sb.ToString(), paras);
