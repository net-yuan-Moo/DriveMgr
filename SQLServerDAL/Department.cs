...
namespace DriveMgr.SQLServerDAL
{
    ...
    /// 部门（SQL Server数据库实现）
    /// </summary>
    public class Department : DriveMgr.IDAL.IDepartment
    {
        /// <summary>
        /// 根据用户id获取用户部门
        /// </summary>
        ...
        public int GetDepartmentUserCount(string departmentIds)
        {
            ...
            object count = DriveMgr.Common.SqlHelper.ExecuteScalar(DriveMgr.Common.SqlHelper.connStr, CommandType.Text, sql, null);
