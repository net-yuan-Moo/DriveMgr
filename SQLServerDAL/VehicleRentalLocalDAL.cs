...
{
    public class VehicleRentalLocalDAL : IVehicleRentalLocalDAL
    {
        /// <summary>
        /// 增加一条数据
        /// </summary>
        public bool AddVehicleRental(VehicleRentalLocalModel model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_VehicleRental_local(");
            strSql.Append("VehicleId,PriceConfigID,Longer,TotalPrice,StudentsID,RentDate,Remark,CreatePerson,CreateDate,UpdatePerson,UpdateDate,DeleteMark)");
            ...
            parameters[4].Value = model.StudentsID;
            parameters[5].Value = model.RentDate;
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateVehicleRental(VehicleRentalLocalModel model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_VehicleRental_local set ");
        ...
        public bool DeleteVehicleRental(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("Update tb_VehicleRental_local Set DeleteMark = 1 ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public VehicleRentalLocalModel GetVehicleRentalModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,VehicleId,PriceConfigID,Longer,TotalPrice,StudentsID,RentDate,Remark,CreatePerson,CreateDate,UpdatePerson,UpdateDate,DeleteMark from tb_VehicleRental_local ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            VehicleRentalLocalModel model = new VehicleRentalLocalModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        private VehicleRentalLocalModel DataRowToModel(DataRow row)
        {
            VehicleRentalLocalModel model = new VehicleRentalLocalModel();
            if (row != null)
            {
