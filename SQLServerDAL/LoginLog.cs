...
namespace DriveMgr.SQLServerDAL
{
    ...
    /// </summary>
    public class LoginLog : DriveMgr.IDAL.ILoginLog
    {
        /// <summary>
        /// 根据条件查询记录总数
        /// </summary>
        public int GetTotalCount(string where)
        {
            ...
            object count = DriveMgr.Common.SqlHelper.ExecuteScalar(DriveMgr.Common.SqlHelper.connStr, CommandType.Text, strSql.ToString(), null);
        ...
        public DateTime? CheckLogin(string ip, out DateTime? lastLoginTime)
        {
            ...
            DriveMgr.Common.SqlHelper.ExecuteScalar(DriveMgr.Common.SqlHelper.connStr, CommandType.StoredProcedure, "sp_CheckLogin", paras);
        ...
        public bool WriteLoginLog(Model.LoginLog loginInfo)
        {
            ...
            object count = DriveMgr.Common.SqlHelper.ExecuteNonQuery(DriveMgr.Common.SqlHelper.connStr, CommandType.Text, sql, paras);
