...
{
    public class SiteRentalLocalBLL
    {
        private static readonly DriveMgr.IDAL.ISiteRentalLocalDAL siteRentalDal = DriveMgr.DALFactory.Factory.GetSiteRentalLocalDAL();

        /// <summary>
        /// 增加一条数据
        /// </summary>
        public bool AddSiteRental(Model.SiteRentalLocalModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateSiteRental(Model.SiteRentalLocalModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.SiteRentalLocalModel GetSiteRentalModel(int id)
        {
