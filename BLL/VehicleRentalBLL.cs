...
{
    public class VehicleRentalBLL
    {
        private static readonly DriveMgr.IDAL.IVehicleRentalDAL vehicleRentalDal = DriveMgr.DALFactory.Factory.GetVehicleRentalDAL();

        /// <summary>
        /// 增加一条数据
        /// </summary>
        public bool AddVehicleRental(Model.VehicleRentalModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateVehicleRental(Model.VehicleRentalModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.VehicleRentalModel GetVehicleRentalModel(int id)
        {
