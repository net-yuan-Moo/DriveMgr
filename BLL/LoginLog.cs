...
namespace DriveMgr.BLL
{
    ...
    public class LoginLog
    {
        ...
        //private static DriveMgr.IDAL.ILoginInfo dal;     //方式一：数据访问对象dal为null，通过构造函数赋值
        //public LoginInfo()
        //{
        //    //在BLL都是通过工厂创建的对象实例
        //    dal = DriveMgr.DALFactory.Factory.GetLoginInfoDALs();
        //}

        //方式二，初始化的时候直接赋值（dal为静态的，只初始化一次，所有的实例通通过这一个对象去操作）：
        private static readonly DriveMgr.IDAL.ILoginLog dal = DriveMgr.DALFactory.Factory.GetLoginInfoDAL();
