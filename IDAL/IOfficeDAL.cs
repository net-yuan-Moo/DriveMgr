...
namespace DriveMgr.IDAL
{
    public interface IOfficeDAL
    {
        ...
        /// 增加一条数据
        /// </summary>
        bool AddOffice(Model.OfficeModel model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool UpdateOffice(Model.OfficeModel model);
        ...
        /// 批量删除数据
        /// </summary>
        bool DeleteOfficeList(string idlist);

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        Model.OfficeModel GetOfficeModel(int id);
