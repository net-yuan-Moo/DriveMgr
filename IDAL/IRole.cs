...
namespace DriveMgr.IDAL
{
    ...
    public interface IRole
    {
        ...
        /// 根据角色名获取角色
        /// </summary>
        DriveMgr.Model.Role GetRoleByRoleName(string roleName);

        /// <summary>
        /// 添加角色
        /// </summary>
        int AddRole(DriveMgr.Model.Role role);
        ...
        /// 修改角色
        /// </summary>
        bool EditRole(DriveMgr.Model.Role role);
        ...
        /// 角色授权
        /// </summary>
        bool Authorize(List<DriveMgr.Model.RoleMenuButton> role_menu_button_addlist, List<DriveMgr.Model.RoleMenuButton> role_menu_button_deletelist);
