...
{
    public interface IVehicleRentalDAL
    {
        /// <summary>
        /// 增加一条数据
        /// </summary>
        bool AddVehicleRental(Model.VehicleRentalModel model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool UpdateVehicleRental(Model.VehicleRentalModel model);
        ...
        /// 得到一个对象实体
        /// </summary>
        Model.VehicleRentalModel GetVehicleRentalModel(int id);
