...
{
    public interface ISiteRentalLocalDAL
    {
        /// <summary>
        /// 增加一条数据
        /// </summary>
        bool AddSiteRental(Model.SiteRentalLocalModel model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool UpdateSiteRental(Model.SiteRentalLocalModel model);
        ...
        /// 得到一个对象实体
        /// </summary>
        Model.SiteRentalLocalModel GetSiteRentalModel(int id);
