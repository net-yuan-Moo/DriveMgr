...
namespace DriveMgr.SQLServerDALTest
{
    /// <summary>
    /// LoginInfo测试类
    /// </summary>
    ...
    public class LoginLogTest
    {
        ...
        {
            DriveMgr.IDAL.ILoginLog loginInfoDal = DriveMgr.DALFactory.Factory.GetLoginInfoDAL();  //数据库访问对象
        ...
        {
            DriveMgr.IDAL.ILoginLog loginInfoDal = DriveMgr.DALFactory.Factory.GetLoginInfoDAL();
            int count = loginInfoDal.GetTotalCount("1=1");
        ...
        {
            DriveMgr.BLL.LoginLog bll = new BLL.LoginLog();
