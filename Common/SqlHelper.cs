...
namespace DriveMgr.Common
{
    ...
    public abstract class SqlHelper
    {
        ...
        //读取配置文件里的数据库连接字符串
        public static readonly string connStrDriveData = ConfigurationManager.ConnectionStrings["connDriveData"].ConnectionString;

        //财务管理及物资管理连接字符串
        public static readonly string financialMgrConn = ConfigurationManager.ConnectionStrings["financialMgrConn"].ConnectionString;
